...
public:
  ...
  void init()
  {
    ...
    hud_sub_ = it.subscribe("/vehicle_1/main_feed/image_raw/compressed", 1, &HUDOverlayNode::imageCallback, this, &hints);
    //hud_pub_ = it.advertise("/hud_overalay", 1);
    rearview_sub = it.subscribe("/vehicle_1/rear_feed/image_raw/compressed", 1, &HUDOverlayNode::rearImageCallback, this, &hints);
